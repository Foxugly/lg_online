...
from company.proposal_views import CompanyProposalUpdateView, CompanyProposalListView, send_proposal, confirm_proposal, CompanyProposalPdfView
...
urlpatterns = [
    ...
    path('proposal/<int:pk>/confirm/<str:uidb64>/<str:token>/', confirm_proposal, name='confirm_proposal'),
