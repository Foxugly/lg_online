...
from simulation.forms import SimulationReadonlyForm
...
def send_proposal(request, pk):
    c = Company.object.get(pk=pk)
    c.send_adjusted_proposition()
    context = {'title': _('Activation'),'text': _('Activation link is invalid!'),}
