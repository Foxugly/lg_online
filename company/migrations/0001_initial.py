    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enterprise_number',
                 models.CharField(max_length=30, null=True, validators=[vies.validators.VATINValidator(verify=True)],
                                  verbose_name='Enterprise Number')),
                ...
                ('end_fiscal_date', models.CharField(
                    choices=[('1', '31 mars'), ('2', '30 juin'), ('3', '30 septembre'), ('4', '31 décembre'),
                             ('0', 'autre')], default=4, max_length=50, verbose_name='End fiscal date')),
                ...
                ('social_address_country',
                 django_countries.fields.CountryField(blank=True, default='BE', max_length=255,
                                                      verbose_name='Country')),
                ('valid', models.BooleanField(default=False)),
                ('valid_user', models.BooleanField(default=False)),
                ('sent', models.BooleanField(default=False)),
                ('accountant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                 to='accountant.Accountant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('iban',
                 localflavor.generic.models.IBANField(blank=True, include_countries=None, max_length=20, null=True,
                                                      use_nordea_extensions=False, verbose_name='Iban')),
