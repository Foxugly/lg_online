...
class Simulation(GenericClass):
    nb_documents = models.PositiveIntegerField(_("Nombre de documents annuels (factures de vente, factures d'achat et tickets)"))
    ...
    def compute(self):
        ...
        s = V_nb_docs + V_nb_managers + V_nb_employees + V_nb_creditcard + V_alternatif_payments
