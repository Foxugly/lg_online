...
def fid(driver, user, password):
    ...
    # adresse
    # ligne 1
    driver.find_element_by_xpath('//*[@id="ngdialog4"]/div[2]/div/div[2]/div[1]/div/table/tbody/tr[10]/td/fieldset/'
                                 'div[1]/input[1]')\
        .send_keys("Ligne 1")
    # ville
    driver.find_element_by_xpath('//*[@id="ngdialog4"]/div[2]/div/div[2]/div[1]/div/table/tbody/tr[10]/td/fieldset/'
    ...
    # checkboxes
    # déclarations TVA
    driver.find_element_by_xpath('//*[@id="ngdialog4"]/div[2]/div/div[2]/div[1]/div/table/tbody/tr[11]/td[2]/'
                                 'div/div').click()
    # Listing annuels
    driver.find_element_by_xpath('//*[@id="ngdialog4"]/div[2]/div/div[2]/div[1]/div/table/tbody/tr[12]/td[2]/'
                                 'div/div').click()
    # cloture des sociétés
    driver.find_element_by_xpath('//*[@id="ngdialog4"]/div[2]/div/div[2]/div[1]/div/table/tbody/tr[13]/td[2]/'
                                 'div/div').click()
    # IPP
    driver.find_element_by_xpath('//*[@id="ngdialog4"]/div[2]/div/div[2]/div[1]/div/table/tbody/tr[14]/td[2]/'
                                 'div/div').click()
    # PP
    driver.find_element_by_xpath('//*[@id="ngdialog4"]/div[2]/div/div[2]/div[1]/div/table/tbody/tr[15]/td[2]/'
                                 'div/div').click()
    # planning périodique
    driver.find_element_by_xpath('//*[@id="ngdialog4"]/div[2]/div/div[2]/div[1]/div/table/tbody/tr[16]/td[2]/'
                                 'div/div').click()
    # devoir d'information UBO
    driver.find_element_by_xpath('//*[@id="ngdialog4"]/div[2]/div/div[2]/div[1]/div/table/tbody/tr[17]/td[2]/'
                                 'div/div').click()
    # registre UBO
    driver.find_element_by_xpath('//*[@id="ngdialog4"]/div[2]/div/div[2]/div[1]/div/table/tbody/tr[18]/td[2]/'
                                 'div/div').click()
    # Etats financiers
    driver.find_element_by_xpath('//*[@id="ngdialog4"]/div[2]/div/div[2]/div[1]/div/table/tbody/tr[19]/td[2]/'
                                 'div/div').click()
