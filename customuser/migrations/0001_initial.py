    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language',
                 models.CharField(choices=[('en', 'English'), ('fr', 'Français'), ('nl', 'Nederlands')], default=1,
                                  max_length=8, verbose_name='language')),
                ('telephone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=20, region=None,
                ...
                ('address_country', django_countries.fields.CountryField(blank=True, default='BE', max_length=255,
                ...
                ('groups', models.ManyToManyField(blank=True,
                                                  ...
                                                  verbose_name='groups')),
                ('simulation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
