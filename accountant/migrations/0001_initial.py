    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('free_slot_color',
                 models.CharField(default='#73B5EB', max_length=8, verbose_name='Free pricing free slot color')),
                ('booked_slot_color',
                 models.CharField(default='#F64636', max_length=8, verbose_name='Booked slot color')),
            ],
        ),
        migrations.CreateModel(
            name='Accountant',
            fields=[
                ...
                ('telephone',
                 phonenumber_field.modelfields.PhoneNumberField(blank=True, help_text='format : +3221234567',
